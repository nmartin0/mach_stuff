/*
 * HISTORY
 * 26-Oct-93  Mary Thompson (mrt) at Carnegie-Mellon University
 *	In this case we want to local (alpha) verison of a.out.h
 *	even if compiling on a pmax, hence <a.out.h> to "a.out.h".
 *
 * $Log:	a.out.h,v $
 * Revision 1.2  90/08/31  09:39:10  bww
 * 	Use <>'s to find the real a.out.h.
 * 	[90/08/31  09:35:39  bww]
 * 
 */
