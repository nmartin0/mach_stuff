...
#ifdef	CONFIG_OSFMACH3
	mach_port_t	b_reply_port;	/* reply port for Mach device calls */
#endif	/* CONFIG_OSFMACH3 */
};
...
#ifdef	CONFIG_OSFMACH3
	struct i_mem_object *i_mem_object;	/* for the inode pager */
#else
	void *i_mem_object__UNUSED__;		/* for module compatability */
#endif	/* CONFIG_OSFMACH3 */
};
