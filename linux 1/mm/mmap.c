...
static 
#endif	/* CONFIG_OSFMACH3 */
 inline void avl_neighbours (struct vm_area_struct * node, struct vm_area_struct * tree, struct vm_area_struct ** to_the_left, struct vm_area_struct ** to_the_right)
{
...
static 
#endif	/* CONFIG_OSFMACH3 */
 inline void avl_insert (struct vm_area_struct * new_node, struct vm_area_struct ** ptree)
{
...
#ifdef	CONFIG_OSFMACH3
	/*
	 * Split the map so that we won't remove extra mappings
	 * that we wouldn't be able to recreate in unmap_fixup()...
	 */
	ret = osfmach3_split_vm_struct(addr, len);
	if (ret)
		return ret;
#endif	/* CONFIG_OSFMACH3 */
...
void insert_vm_struct(struct mm_struct *mm, struct vm_area_struct *vmp)
{
	...
	*p = vmp;
	...
	if (!inode) {
#ifdef	CONFIG_OSFMACH3
		osfmach3_insert_vm_struct(mm, vmp);
#endif	/* CONFIG_OSFMACH3 */
		return;
	}
...
#ifdef	CONFIG_OSFMACH3
	osfmach3_remove_shared_vm_struct(mpnt);
#endif	/* CONFIG_OSFMACH3 */
