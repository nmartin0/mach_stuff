...
/*
 * EXT2FS entry points and structure definitions
 */
...
#include <mach.h>
#include <ext2fs/ext2_ffs_compat.h>
...
struct ext2fs_file {
	...
	struct ext2_super_block*f_fs;		/* pointer to super-block */
