...
#ifdef	CONFIG_OSFMACH3
	put_user(current->osfmach3.thread->trap_no, frame+14);
	put_user(current->osfmach3.thread->error_code, frame+15);
#else	/* CONFIG_OSFMACH3 */
...
/* non-iBCS2 extensions.. */
	...
	put_user(current->osfmach3.thread->fault_address, frame+23);
