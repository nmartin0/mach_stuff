...
# include "hfs/btree.h"
# include "hfs/node.h"
# include "hfs/record.h"
# include "hfs/volume.h"

char *hfs_error = (char *)"no error";	/* static error string */
...
#ifndef ERROR
void ERROR(int errnum, const char *str)
{
  hfs_error = (char *)str;
  errno = errnum;
}
 ...
 */
hfsvol *hfs_mount(struct device *machdev)
{
#if 0
  struct stat dev;
#endif
