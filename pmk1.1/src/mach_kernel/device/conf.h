...
#define	NULL_ASYNC	(io_return_t (*)(dev_t, ipc_port_t, int, filter_t *, mach_msg_type_number_t, device_t))nulldev
...
#define	NO_ASYNC	(io_return_t (*)(dev_t, ipc_port_t, int, filter_t *, mach_msg_type_number_t, device_t))nodev
