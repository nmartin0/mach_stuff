...
/* CMU_HIST */
/*
 * Revision 2.2.3.1  92/03/03  16:24:27  jeffreyh
 * 	Changes form TRUNK
 * 	[92/02/26  12:26:18  jeffreyh]
 * 
 * Revision 2.3  92/01/03  20:42:28  dbg
 * 	Made various chars unsigned, else we screwup in outbs.
 * 	[Found by bernadat@gr.osf.org]
 * 
 * Revision 2.2  91/08/24  12:27:19  af
...
#	define	AHA_BID_1540C			0x44
#	define	AHA_BID_1540CF			0x45
#	define  AHA_BID_1540CP			0x46
...
#define AHA_CMD_EXT_BIOS	0x28	/* get extended bios info */
struct  aha_extbios
{
        unsigned char  flags;        /* Bit 3 == 1 extended bios enabled */
        unsigned char  mailboxlock;  /* mail box lock code to unlock it */
};
#define	AHA_CMD_MBX_ENABLE	0x29	/* enable mailbox interface */
