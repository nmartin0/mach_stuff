...
extern struct	bus_driver	hba_driver;
#endif /* NHBA */
...
extern	struct	bus_driver	ktdriver;
#endif	/* NKKT */

#include <sce.h>
#if	NSCE > 0
#include <scsi/if_sce.h>
extern	struct	bus_driver	scedriver;
#endif	/* NSCE */
...
extern	struct	bus_driver	sbdriver;
#endif /* NSB */
...
/* DOC sez these are possible too: */
  ...
  {&aha_driver, "ahac",  0, (intr_t)aha_intr, (caddr_t)0x234, 4,(caddr_t)0x234,
     '?',	0,  0,	 SPL_FIVE, 11},
  {&aha_driver, "ahac",  1, (intr_t)aha_intr, (caddr_t)0x230, 4,(caddr_t)0x230,
     '?',	0,  0,	 SPL_FIVE, 11},
...
{ &hba_driver,	"rz",   1,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   1,    0, },
{ &hba_driver,	"rz",   2,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   2,    0, },
{ &hba_driver,	"rz",   3,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   3,    0, },
{ &hba_driver,	"rz",   4,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   4,    0, },
{ &hba_driver,	"rz",   5,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   5,    0, },
{ &hba_driver,	"rz",   6,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   6,    0, },
{ &hba_driver,	"rz",   7,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   7,    0, },

{ &hba_driver,	"tz",   0,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   0,    0, },
{ &hba_driver,	"tz",   1,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   1,    0, },
{ &hba_driver,	"tz",   2,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   2,    0, },
{ &hba_driver,	"tz",   3,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   3,    0, },
{ &hba_driver,	"tz",   4,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   4,    0, },
{ &hba_driver,	"tz",   5,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   5,    0, },
{ &hba_driver,	"tz",   6,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   6,    0, },
{ &hba_driver,	"tz",   7,  NO_INTR,  0x0,0,	0,    '?',     0,   0,   7,    0, },
#endif /* NHBA > 0 */
...
#if NEAHA > 1
{ &eaha_driver,	"sc",   8,  0,  0x0,0,	0,    '?',     0,   1,   0,    0, },
{ &eaha_driver,	"sc",   9,  0,  0x0,0,	0,    '?',     0,   1,   1,    0, },
{ &eaha_driver,	"sc",  10,  0,  0x0,0,	0,    '?',     0,   1,   2,    0, },
{ &eaha_driver,	"sc",  11,  0,  0x0,0,	0,    '?',     0,   1,   3,    0, },
{ &eaha_driver,	"sc",  12,  0,  0x0,0,	0,    '?',     0,   1,   4,    0, },
{ &eaha_driver,	"sc",  13,  0,  0x0,0,	0,    '?',     0,   1,   5,    0, },
{ &eaha_driver,	"sc",  14,  0,  0x0,0,	0,    '?',     0,   1,   6,    0, },
{ &eaha_driver,	"sc",  15,  0,  0x0,0,	0,    '?',     0,   1,   7,    0, },
...
#if	NKKT > 0
    {&ktdriver, "kkt", 0, (intr_t)0, (caddr_t)0, 0, (caddr_t)0,
	 '?', 0, -1, -1, 0, 0, 0, SPL_SIX, 0},
#endif	/* NKKT > 0 */

#if	NSCE > 0
    {&scedriver, "sce", 0, (intr_t)0, (caddr_t)0, 0, (caddr_t)0,
	 '?', 0, -1, -1, 0, 0, 0, SPL_SIX, 0},
#endif	/* NSCE > 0 */
  ...
  {&ns8390driver, "wd", 0, (intr_t)ns8390intr, (caddr_t)0x2a0,0x2000,(caddr_t)0xd0000,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_SIX, 9},
  {&ns8390driver, "wd", 0, (intr_t)ns8390intr, (caddr_t)0x2c0,0x2000,(caddr_t)0xd8000,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_SIX, 9},
  {&ns8390driver, "wd", 1, (intr_t)ns8390intr, (caddr_t)0x2e0,0x2000,(caddr_t)0xcc000,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_SIX, 5},
  {&ns8390driver, "wd", 0, (intr_t)ns8390intr, (caddr_t)0x300,0x2000,(caddr_t)0xd8000,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_SIX, 5},
  {&ns8390driver, "wd", 0, (intr_t)ns8390intr, (caddr_t)0x320,0x2000,(caddr_t)0xd8000,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_SIX, 7},
...
/* ^^^ MITCHEM ^^^ */ 
  ...
  {&comdriver, "com", 2, (intr_t)comintr, (caddr_t)0x3e8, 8, (caddr_t)0x3e8,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_TTY, 10},
  {&comdriver, "com", 3, (intr_t)comintr, (caddr_t)0x2e8, 8, (caddr_t)0x2e8,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_TTY, 11},
#endif /* NCOM > 0 */
...
#if NSB > 0
/*
 * driver, name, unit, intr, address, address mod(DMA), phys addr,
 * adaptor, alive, ctlr, slave, flags, mi, next, sysdep(spl), sysdep1(IRQ)
 */
  {&sbdriver, "sb", SNDCARD_SB, (intr_t)sbintr, (caddr_t)SBC_BASE, SBC_DMA, (caddr_t)SBC_BASE,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_FIVE, SBC_IRQ},
  {&sbdriver, "sb16", SNDCARD_SB16, (intr_t)sbintr, (caddr_t)SBC_BASE, SB16_DMA, (caddr_t)SBC_BASE,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_FIVE, SBC_IRQ},
  {&sbdriver, "sb16midi", SNDCARD_SB16MIDI, (intr_t)sbintr, (caddr_t)SB16MIDI_BASE, 0, (caddr_t)SB16MIDI_BASE,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_FIVE, SBC_IRQ},
  {&sbdriver, "fm", SNDCARD_ADLIB, (intr_t)sbintr, (caddr_t)FM_MONO, 0, (caddr_t)FM_MONO,
     '?',    0,   -1,    -1,    0,   0,        0,   SPL_FIVE, SBC_IRQ},
#endif /* NSB > 0 */
...
void
take_irq(int pic, int unit, int spl, intr_t intr)
{
#if	MP_V1_1
...
{
#if	MP_V1_1
	if (mp_v1_1_reset_irq(pic, unit, spl, intr))
		return;
#endif	/* MP_V1_1 */
	if (intpri[pic] == 0) {
	  	*unit = 0;
...
{
	take_irq((int)dev->sysdep1, dev->unit, (int)dev->sysdep, dev->intr);
}
...
{
	take_irq((int)ctlr->sysdep1, ctlr->unit, (int)ctlr->sysdep, ctlr->intr);
}
