...
/* CMU_HIST */
/*
 * Revision 2.5.7.1  92/02/18  18:55:58  jeffreyh
 * 	Parallelized event handling
 * 	[91/07/16            bernadat]
 * 
 * Revision 2.5  91/05/14  16:27:51  mrt
 * 	Correcting copyright
 * 
 * Revision 2.4  91/02/05  17:19:32  mrt
 * 	Changed to new Mach copyright
 * 	[91/02/01  17:45:59  mrt]
 * 
 * Revision 2.3  90/11/26  14:50:37  rvb
...
extern void		kdq_put(
					kd_event_queue	* q,
					kd_event	* ev);
extern void		kdq_reset(
					kd_event_queue	* q);
extern boolean_t	kdq_empty(
					kd_event_queue	* q);
extern boolean_t	kdq_full(
					kd_event_queue	* q);
extern kd_event		*kdq_get(
					kd_event_queue	* q);

#define kdq_next(q) 	(q)->events + (q)->firstout

#define	kdq_lock(q)	simple_lock(&(q)->lock)
#define	kdq_unlock(q)	simple_unlock(&(q)->lock)
