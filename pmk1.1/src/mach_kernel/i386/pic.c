...
/* CMU_HIST */
/*
 * Revision 2.10.8.2  92/03/28  10:05:30  jeffreyh
 * 	iPSC386 changes from Intel
 * 	[92/03/17            jeffreyh]
 * 
 * Revision 2.10.8.1  92/02/18  18:48:56  jeffreyh
...
i386_ioport_t	master_icw, master_ocw, slaves_icw, slaves_ocw;
...
picinit(void)
{
	...
	*/
	...
	master_icw = (i386_ioport_t)(ADDR_PIC_BASE + OFF_ICW);
	master_ocw = (i386_ioport_t)(ADDR_PIC_BASE + OFF_OCW);
	slaves_icw = (i386_ioport_t)(ADDR_PIC_BASE + OFF_ICW + SIZE_PIC);
	slaves_ocw = (i386_ioport_t)(ADDR_PIC_BASE + OFF_OCW + SIZE_PIC);
