 ...
 * pmk1.1
 */
/* Old ppc directory log follows
 * Revision 1.1.8.2  1996/08/07  14:22:32  stephen
 * 	Added speed and flags entries to scc_softreg
 * 	[1996/08/07  14:19:39  stephen]
 *
 * Revision 1.1.8.1  1996/07/29  09:41:55  stephen
 * 	scc_set/get_datum are now functions
 * 	[1996/07/29  09:28:02  stephen]
 * 
 * Revision 1.1.6.2  1996/05/03  17:26:55  stephen
 * 	Added APPLE_FREE_COPYRIGHT
 * 	[1996/05/03  17:22:01  stephen]
 * 
 * Revision 1.1.6.1  1996/04/11  09:12:00  emcmanus
 * 	Copied from mainline.ppc.
 * 	[1996/04/11  08:04:41  emcmanus]
 * 
 * Revision 1.1.4.1  1995/11/23  17:41:46  stephen
 * 	first powerpc checkin to mainline.ppc
 * 	[1995/11/23  16:57:38  stephen]
 * 
 * Revision 1.1.2.2  1995/11/16  21:57:49  stephen
 * 	bugfix
 * 	[1995/11/16  21:38:19  stephen]
 * 
 * Revision 1.1.2.1  1995/11/02  15:18:45  stephen
 * 	first implementation of serial console from MB oct-1024
 * 	[1995/10/30  08:26:04  stephen]
 * 
 * Revision 1.2.10.2  1995/01/06  18:52:40  devrcs
 * 	mk6 CR668 - 1.3b26 merge
 * 	Generalized register access, to accomodate Alpha.
 * 	[1994/10/14  03:39:41  dwm]
 * 
 * Revision 1.2.10.1  1994/09/23  01:10:12  ezf
 * 	change marker to not FREE
 * 	[1994/09/22  21:05:27  ezf]
 * 
 * Revision 1.2.3.2  1993/06/09  02:15:13  gm
 * 	Added to OSF/1 R1.3 from NMK15.0.
 * 	[1993/06/02  20:52:41  jeffc]
 * 
 * Revision 1.2  1993/04/19  15:16:56  devrcs
 * 	Changes from mk78:
 ...
 * 	[93/02/04            bruel]
 * 
 * Revision 1.1  1992/09/30  02:23:58  robert
 * 	Initial revision
 * 
 */
/* CMU_HIST */
...
struct scc_dma_ops {
	void		(*scc_dma_init)(int chan);
	void		(*scc_dma_setup_8530)(int chan);
	void		(*scc_dma_start_rx)(int chan);
	void		(*scc_dma_reset_rx)(int chan);
	void		(*scc_dma_start_tx)(int chan, struct tty *tp);
	void		(*scc_dma_pause_tx)(int chan);
	void		(*scc_dma_continue_tx)(int chan);
};
