...
#define	STI_CODESIZ	(10 * 1024)		/* 10K per routine */
#define	STI_CODECNT	7			/* 7 routines */
...
#define	STI_FONTAD(t,a)	STI_GETWORD(t,a,sti_fontaddr)
#define	STI_MSS(t,a)	STI_GETWORD(t,a,sti_mss)
#define	STI_EROM(t,a)	STI_GETWORD(t,a,sti_erom)
#define	STI_MMAP(t,a)	STI_GETWORD(t,a,sti_mmap)
#define	STI_MSTOR(t,a)	STI_GETHALF(t,a,sti_mstore)
#define	STI_MTOUT(t,a)	STI_GETHALF(t,a,sti_mtimo)

#define	STI_IGADDR(t,a)	STI_GETWORD(t,a,sti_routine[0])	/* INIT_GRAPH address */
#define	STI_SMADDR(t,a)	STI_GETWORD(t,a,sti_routine[1])	/* STATE_MGMT address */
#define	STI_FUADDR(t,a)	STI_GETWORD(t,a,sti_routine[2])	/* FONT_UNP/MV address*/
#define	STI_BMADDR(t,a)	STI_GETWORD(t,a,sti_routine[3])	/* BLOCK_MOVE address */
#define	STI_STADDR(t,a)	STI_GETWORD(t,a,sti_routine[4])	/* SELF_TEST address */
#define	STI_EHADDR(t,a)	STI_GETWORD(t,a,sti_routine[5])	/* EXCEP_HDLR address */
#define	STI_ICADDR(t,a)	STI_GETWORD(t,a,sti_routine[6])	/* INQ_CONF address */
#define	STI_EADDR(t,a)	STI_GETWORD(t,a,sti_routine[7])	/* End address */
