 ...
 *
 * 	Utah $Hdr: if_i596reg.h 3.5 92/05/27$
 */
/*
...
/*
 * 82586 chip specific structure definitions as it appears on the ASP.
 * For details, see the Intel LAN Components manual.
 */
