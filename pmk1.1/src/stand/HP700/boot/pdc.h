...
#ifndef	_HP700_PDC_H_
#define _HP700_PDC_H_
...
#define	pz_layers	pz_dp.dp_layers
	...
	char *	pz_spa;		/* SPA base address (zero if no SPA exists) */
	int	(*pz_iodc_io)(struct iomod*, ...);/* entry point of device's driver routines */
