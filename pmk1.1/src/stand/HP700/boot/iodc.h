...
#ifndef	ASSEMBLER
struct iodc_data {
	unsigned int	iodc_model: 8,		/* hardware model number */
	...
	unsigned int	iodc_sv_rev: 4,		/* software version revision number */
		iodc_sv_model:20,	/* software interface model # */
		iodc_sv_opt: 8;		/* type-specific options */
	unsigned char	iodc_rev;		/* revision number of IODC code */
	unsigned char	iodc_dep;		/* module-dependent information */
	unsigned char	iodc_rsv[2];		/* reserved */
	unsigned short	iodc_cksum;		/* 16-bit checksum of whole IODC */
	unsigned short	iodc_length;		/* number of entry points in IODC */
