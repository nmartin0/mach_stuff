...
# sun/rthread_inline.awk
#
# Awk script to inline critical R Threads primitives on i386
...
NF == 2 && $1 == "call" && $2 == "_rthread_sp" {
	print	"/	BEGIN INLINE rthread_sp"
	print	"	movl	%esp,%eax"
	print	"/	END INLINE rthread_sp"
	continue
}
# default:
{
