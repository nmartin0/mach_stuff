...
#define DBDMA_ALIGN(a)	(((unsigned int)(a) + sizeof(dbdma_command_t) - 1) \
...
#define	PDM_DBDMA_REGMAP(channel) \
		(dbdma_regmap_t *)((v_u_char *) POWERMAC_IO(PDM_DMA_CTRL_BASE_PHYS) \
				+ (channel << 8))

#define	DBDMA_REGMAP2(channel) \
		(dbdma_regmap_t *)((v_u_char *) POWERMAC_IO2(PCI_DMA_BASE_PHYS + 0x01000000) \
				+ (channel << 8))
