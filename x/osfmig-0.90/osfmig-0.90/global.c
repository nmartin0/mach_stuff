...
more_global()
{
	...
	/* ServerSubsys = strconcat(RoutinePrefix, ServerSubsys); */
	/*
	new = malloc (strlen (RoutinePrefix) + strlen (ServerSubsys) + 1);
	strcpy (new, RoutinePrefix);
	strcat (new, ServerSubsys);
	free (ServerSubsys);
	ServerSubsys = new;
	*/
    }
