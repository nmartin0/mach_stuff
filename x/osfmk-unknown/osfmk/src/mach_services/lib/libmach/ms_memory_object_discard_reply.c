...
extern kern_return_t memory_object_discard_reply(
	...
	mach_port_t reply_to)
{
	...
	kr = syscall_memory_object_discard_reply(memory_control,
						 requested_offset,
						 requested_size,
						 discard_offset,
						 discard_size,
	...
	if (kr == MACH_SEND_INTERRUPTED)
		kr = mig_memory_object_discard_reply(memory_control,
						     requested_offset,
						     requested_size,
						     discard_offset,
						     discard_size,
