 ...
 *
 * altered to deal with HFS Extended format
 */
struct raw_mdb {
	...
	hfs_lword_t     drEmbedExtent;  /* starting allocation block 
					   (xdrStABN) followed by number of
					   allocation blocks (xdrNumABlks)
					   of the embedded volume */
