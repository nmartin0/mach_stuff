...
/*
static const char RCSid[] = "$Header: /MkLinux/mklinux/src/drivers/scsi/scsi.c,v 1.5 1999/03/28 11:31:36 nester Exp $";
*/
...
#ifdef __powerpc__
    /* For some reason, interrupts can get stuck when both the SCSI and */
    /* ethernet are busy.  This tries to get it restarted               */
    check_irq();
/* SCSI timeout disabled! */  return;
#endif	
...
#ifdef __powerpc__
        if (host->host_busy == 0) hard_disk_LED(0);
#endif
