...
static const char *version = 
	"Equalizer1996: $Revision: 1.4 $ $Date: 1999/05/29 19:16:47 $ Simon Janes (simon@ncm.com)\n";
...
/*
 * $Log: eql.c,v $
 * Revision 1.4  1999/05/29 19:16:47  nester
 *
 * 2.0.37pre12
 * -- Tom Vier <thomassr@erols.com>
 *
 * Revision 1.3  1999/04/30 22:11:48  nester
 *
 * 2.0.37pre11
 * -- Tom Vier <thomassr@erols.com>
 *
 * Revision 1.2  1998/10/05 23:44:39  dgatwood
 * This update fixes PB5300 greyscale support, xclaim at high resolutions, and
 * updates the linux server to 2.0.35.  It also includes fixes for several
 * memory management issues that cause crashes when swap is exhausted.
 *
 *
 * dgatwood@globegate.utm.edu
 *
 * Revision 1.1.1.1  1998/10/02 21:12:39  root
 * This is mklinux 2.0.33-osfmach3 (stock DR3) as far as I am aware.
 *
 *
 * dgatwood@globegate.utm.edu
 *
