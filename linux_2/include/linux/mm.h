...
#ifdef	CONFIG_OSFMACH3
#define VM_REMAPPING	0x8000	/* remapping only: don't mess with Mach VM */
#endif	/* CONFIG_OSFMACH3 */
...
#ifdef	CONFIG_OSFMACH3
	if (page && !free_area_page_dirty(page)) {
		/*
		 * This page is fresh from the microkernel so it
		 * as already been zero-filled.
		 */
		return page;
	}
#endif	/* CONFIG_OSFMACH3 */
