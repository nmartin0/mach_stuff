...
#define CF_LE_W(v) \
     ((unsigned short int)((((unsigned short int)(v) & 0x00ff) << 8) |	\
			   (((unsigned short int)(v) & 0xff00) >> 8)))
#define CF_LE_L(v) \
     ((unsigned long int)((((unsigned long int)(v) & 0x000000ffU) << 24) |  \
			  (((unsigned long int)(v) & 0x0000ff00U) << 8) |   \
			  (((unsigned long int)(v) & 0x00ff0000U) >> 8) |   \
			  (((unsigned long int)(v) & 0xff000000U) >> 24)))
