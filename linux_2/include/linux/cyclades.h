/* $Revision: 1.5 $$Date: 1999/04/17 10:30:59 $
 ...
 * $Log: cyclades.h,v $
 * Revision 1.5  1999/04/17 10:30:59  nester
 *
 * linux 2.0.37pre10
 * -- Tom Vier <thomassr@erols.com>
 *
 * Revision 1.4  1999/02/13 05:48:18  nester
 *
 *
 * 2.0.37 pre-patch 5. Next commit will tag mklinux-2-0-37-pre-patch-5, since
 * added files must be committed first.
 *
 * 	-- Tom Vier <thomassr@erols.com>
 *
 * Revision 1.3  1998/11/18 22:25:19  trini
 * Merge to 2.0.36
 *
 * Revision 1.2  1998/10/19 15:54:35  dgatwood
 *
 * I'm not sure if anything's really different here, but supposedly these files
 * were locally modified....
 *
 * dgatwood@globegate.utm.edu
 *
 * Revision 1.1.1.1  1998/10/02 21:15:58  root
