...
#include <machine/mach_param.h>		/* spl definitions */
#else
...
#ifndef mac2 /* kernel has no machparam.h */
...
#if	NORMA_ETHER
	if (netipc_net_packet(&net_kmsg(kmsg)->header[0],
			      &net_kmsg(kmsg)->packet[sizeof(char *)],
