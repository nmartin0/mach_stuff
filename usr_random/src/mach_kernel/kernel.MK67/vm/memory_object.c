	...
	vm_prot_t	lock_value;
{
        return memory_object_data_supply(object, offset, data, data_cnt,
					 lock_value, FALSE, IP_NULL, 0);
}

/*
 * XXX	Doesn't do continuations. LATER.
 */
	...
	mach_msg_type_name_t	reply_to_type;
{
	...
	vm_map_copy_t	orig_copy = VM_MAP_COPY_NULL;
	...
	mach_msg_type_name_t	reply_to_type;
{
	 ...
	 */
	result = memory_object_set_attributes(object, TRUE, may_cache,
					      copy_strategy);
