...
vm_size_t	zone_map_size = 8 * 1024 * 1024;
...
kern_return_t host_zone_info(host, names, namesCnt, info, infoCnt)
	host_t		host;
	...
	unsigned int	*infoCnt;
{
	...
	*infoCnt = max_zones;
	 ...
	 *	we need to touch it, and then move it to a copy object
