#ifndef lint
static char *RCSdefs = "$Id: defs.h,v 1.8 91/01/03 12:59:52 bww Exp $";
#endif
 ...
 * HISTORY
 * $Log:	defs.h,v $
 * Revision 5.2  91/10/14  13:39:56  berman
 * 	Added declaration for "envover".  setvar() and
 * 	eqsign() now return values in support of -E/-X.
 * 	From STUMP "[91/01/03  12:50:11  bww]".
 * 	[91/10/10            bww]
 * 
...
extern struct varblock *varptr(), *srchvar(), *setvar(), *eqsign();
