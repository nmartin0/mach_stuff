#ifndef lint
static char *RCSid = "$Id: rules.c,v 1.11 90/08/22 13:29:08 bww Exp $";
#endif
 ...
 * HISTORY
 * $Log:	rules.c,v $
 * Revision 5.7  91/10/14  13:42:28  berman
 * 	Purged the CMUCS specific settings for MACHINE/machine.
 * 	[91/10/10            bww]
 * 
 * Revision 5.6  91/05/28  17:20:49  mbj
 * 	Updated mac2 symbols (from macII -> mac2) to match the STUMP.
 * 	[91/05/28  17:14:43  mbj]
 * 
...
char *builtin[] = {
	...
	".S :",
	"\t$(CC) $(LDFLAGS) $(ASFLAGS) $< $(LOADLIBES) -o $@",
