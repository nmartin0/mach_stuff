 ...
 * HISTORY
 * $Log:	rfs_init.c,v $
 * Revision 2.3  90/08/09  16:31:47  rpd
 * 	Added i386 support.
 * 	[90/08/09            rpd]
 * 
 * Revision 2.2  89/12/08  20:18:25  rwd
 * 	Made rfs_initroot() nullifyable, cuz it screws up the name cache
 * 	if there is no superroot.  
 * 	[89/12/05  02:38:55  af]
 * 
 * Revision 2.1  89/08/04  14:09:40  rwd
 * Created.
 * 
...
struct inode *(*rfs_cmusysent[])() =
{
	...
	rfs_oops,			/* 180 */
#endif	BALANCE
#if	!defined(vax) && !defined(romp) && !defined(sun3) && !(BALANCE) && !defined(i386)
	rfs_oops,			/* 151 */
	rfs_oops,			/* 152 */
	rfs_oops,			/* 153 */
	rfs_oops,			/* 154 */
...
#ifndef mac2 /* it is ok if there is no remote file system */
