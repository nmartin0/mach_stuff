...
#ifdef notdef
volatile	mach_msg_header_t *msg;
volatile	mach_msg_option_t option;
volatile	mach_msg_size_t send_size;
volatile	mach_msg_size_t rcv_size;
volatile	mach_port_t rcv_name;
volatile	mach_msg_timeout_t timeout;
volatile	mach_port_t notify;
#else
