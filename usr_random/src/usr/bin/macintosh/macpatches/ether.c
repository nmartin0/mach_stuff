...
OSErr ewrite(etherVars_t v, Eiopb *pb)
{
	...
	{
	    unsigned char *p = (unsigned char *)*(unsigned long *)0x824;
...
OSErr eattachPH(etherVars_t v, Eiopb *pb)
{
...
OSErr edetachPH(etherVars_t v, Eiopb *pb)
{
...
OSErr eaddmulti(etherVars_t v, Eiopb *pb)
{
  en_address_status_t address;
...
OSErr edelmulti(etherVars_t v, Eiopb *pb)
{
  en_address_status_t address;
...
OSErr ether_ctl_calls(etherVars_t v, Eiopb *pb)
{
    OSErr	ret;
...
static void ether_do(register Eiopb *pb, register DCtlPtr dce)
{
  etherVars_t v = (etherVars_t)dce->dCtlStorage;
...
static inline call_dispatch(handler, data, length)
{
...
void etherinput(register etherVars_t v)
{
