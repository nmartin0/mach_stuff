 ...
 * HISTORY
 * $Log:	supcmain.c,v $
 * Revision 1.4  89/11/29  17:40:53  bww
 * 	Changed CMUCS conditionals to CMU.
 * 	[89/11/29  17:33:20  bww]
 * 
 * Revision 1.3  89/08/15  15:31:04  bww
 * 	Fixed some calls to sprintf().
 * 	[89/08/15            bww]
 * 
