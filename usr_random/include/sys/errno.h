 ...
 * HISTORY
 * $Log:	errno.h,v $
 * Revision 2.1  89/08/04  14:45:02  rwd
 * Created.
 * 
...
/*
 *  The EREMOTE code is used to short-circuit standard system call processing
 *  which uses the namei() routine.  When namei() determines that a valid
 *  remote name access has been made, it directly calls the remote file system
...
#endif	CMUCS	/* VICE */
#if	CMUCS	/* MACH_EMULATION */
#define	ERESTART       	72
#endif	CMUCS	/* MACH_EMULATION */
