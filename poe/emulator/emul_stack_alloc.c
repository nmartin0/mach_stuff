 ...
 * Revision 2.5  94/03/25  18:21:19  mrt
 * 	Corrected include of mach/mach.h to mach.h.
 * 	[93/11/15            mrt]
 * 
 * Revision 2.4  92/02/02  13:01:00  rpd
 * 	Changed vm_map to my_vm_map.
 * 
 * Revision 2.3  91/12/19  20:20:15  mrt
 * 	Updated to new copyright
 * 
 * Revision 2.2  90/11/16  11:40:20  rwd
 * 	Taken from UX21
...
emul_stack_alloc()
{
	...
	ret = my_vm_map(mach_task_self(), reply_port,
