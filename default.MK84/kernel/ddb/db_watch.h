...
/*
 *	Quick check for enabled watchpoints.
 */
extern boolean_t	db_watchpoints_inserted;
extern db_watchpoint_t	db_watchpoint_list;

#define	db_watchpoints_enabled() \
		(db_watchpoint_list != 0 && db_watchpoints_inserted)
