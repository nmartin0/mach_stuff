 ...
 * Revision 2.7  93/11/17  16:26:37  dbg
 ...
 * Debugger variables.
 */
struct db_variable;		/* forward */
struct db_var_aux_param;	/* forward */

typedef
void (*db_rw_var_fcn_t)(
...
struct db_variable {
	...
	db_rw_var_fcn_t fcn;	/* function to call when reading/writing */
...
#define	FCN_NULL	((db_rw_var_fcn_t) 0)
