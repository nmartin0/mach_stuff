 ...
 * Revision 2.9  93/11/17  16:26:27  dbg
 * 	Added ANSI function prototypes.
 * 	[93/10/07            dbg]
 * 
 * Revision 2.8  93/01/14  17:26:05  danner
 * 	64bit cleanup.
 * 	[92/11/30            af]
 * 
 * Revision 2.7  92/08/03  17:32:20  jfriedl
 * 	removed silly prototypes
 * 	[92/08/02            jfriedl]
 * 
 * Revision 2.6  92/05/21  17:08:11  jfriedl
	...
	register db_var_aux_param_t	ap)
{
	...
	ap->thread = (db_option(ap->modif, 't'))
			? db_default_thread
			: THREAD_NULL;
	ap->level = level;
	return TRUE;
