 ...
 * HISTORY
 * $Log:	db_lex.h,v $
 * Revision 2.7  93/11/17  16:23:06  dbg
 * 	Enabled prototypes.
 * 	[93/10/06            dbg]
 * 
 ...
 * 	  for macro and conditional command.
...
extern int	db_read_line(char *repeat_last);
...
extern void	db_switch_input(char *buffer, int size);
