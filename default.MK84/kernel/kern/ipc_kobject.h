 ...
 * HISTORY
 * $Log:	ipc_kobject.h,v $
 * Revision 2.10  93/11/17  17:10:50  dbg
 * 	Added IKOT_TIMER.  Added ANSI function prototypes.  Changed
 * 	ipc_kobject_t to a generic pointer (void *).
 * 	[93/02/03            dbg]
 * 
...
typedef void *		ipc_kobject_t;	/* generic pointer */
...
ipc_kobject_server(struct ipc_kmsg *);
