 ...
 * HISTORY
 * $Log:	assert.h,v $
 * Revision 2.8  93/11/17  17:05:47  dbg
 * 	This is the appropriate header to declare 'Debugger' and 'panic'.
 * 	[93/09/30            dbg]
 * 
 * 	ANSI-fied.
 * 	[93/06/16            dbg]
 * 
 * Revision 2.7  93/05/10  17:47:39  rvb
 ...
 * 
 * Revision 2.6  92/05/21  17:12:41  jfriedl
...
#if	MACH_ASSERT
extern void Assert(const char *, const int);
...
/*
 *	Be extremely non-assertive.
 *	(Passive-aggressive is more like it...)
 */
extern void
panic(const char *s, ...);	/* may return if stepped through */
