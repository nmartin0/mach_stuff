 ...
 * HISTORY
 * $Log:	syscall_sw.c,v $
 * Revision 2.17  93/11/17  17:27:13  dbg
 * 	Added traps for new timers and periodic threads.
 * 	[93/07/13            dbg]
 * 
 ...
 * 	comments to trap numbers that are u**xoid traps
 * 	handled by emulator.
 * 	[93/07/19            cmaeda]
 * 
...
#if	MACH_RT
extern	kern_return_t	syscall_periodic_thread_restart();
#endif
extern	kern_return_t	syscall_timer_arm();
extern	kern_return_t	syscall_timer_sleep();
extern	kern_return_t	syscall_timer_cancel();
...
#if	MACH_RT
	MACH_TRAP(syscall_periodic_thread_restart, 1),	/* 101 */
#else	/* MACH_RT */
	MACH_TRAP(kern_invalid, 0),			/* 101 */
#endif	/* MACH_RT */
	MACH_TRAP(syscall_timer_arm, 8),		/* 102 */
	MACH_TRAP_STACK(syscall_timer_sleep, 5),	/* 103 */
	MACH_TRAP(syscall_timer_cancel, 2),		/* 104 */
