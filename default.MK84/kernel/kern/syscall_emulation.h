 ...
 * Revision 2.10  93/11/17  17:25:50  dbg
 * 	Added ANSI function prototypes.  Removed user-visible
 * 	definitions.
 * 	[93/06/16            dbg]
 * 
...
extern kern_return_t	task_set_emulation_vector(
		task_t		task,
		int		vector_start,
		emulation_vector_t emulation_vector,
		natural_t	count);

extern kern_return_t	task_get_emulation_vector(
		task_t		task,
		int		*vector_start,
		emulation_vector_t *emulation_vector,
		natural_t	*count);
