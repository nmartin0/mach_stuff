 ...
 * HISTORY
 * $Log:	eventcount.h,v $
 * Revision 2.7  93/11/17  17:09:07  dbg
 ...
 * 	[93/08/20            dbg]
 * 
 * 	Added return value to evc_init.
 * 	[93/03/02            dbg]
 * 
 * 	Added include files for data types used.
 * 	[93/01/28            dbg]
 * 
...
extern kern_return_t evc_init(evc_t ev);

extern void	evc_destroy(evc_t ev);
extern void	evc_signal(evc_t ev);
extern boolean_t evc_wait_interrupt(thread_t thread);
