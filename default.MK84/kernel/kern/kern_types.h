 ...
 * HISTORY
 * $Log:	kern_types.h,v $
 * Revision 2.3  93/11/17  17:13:32  dbg
 * 	Added macro 'no_return' for the return type of a function that
 * 	does not return.
 * 	[93/05/04            dbg]
 * 
 * Revision 2.2  93/01/14  17:34:51  danner
 * 	Created.
 * 	[92/11/23            dbg]
 * 
 */
...
/*
 *	Return type for a function that does not return.
 */
#ifdef	__GNUC__
#define	no_return	void __volatile__
#else
