 ...
 * HISTORY
 * $Log:	ipc_tt.c,v $
 * Revision 2.15  93/11/17  17:12:01  dbg
 * 	Use task_lock instead of ith_task_lock, thread_lock instead of
 * 	ith_thread_lock.  Remove checks in ipc_task_terminate,
 * 	ipc_thread_terminate for being called twice: caller prevents
 * 	that.
 * 	[93/07/12            dbg]
 * 
 * 	ANSI-fied.
