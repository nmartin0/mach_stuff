 ...
 * HISTORY
 * $Log:	ipc_tt.h,v $
 * Revision 2.7  93/11/17  17:12:22  dbg
 * 	ANSI-fied.
 * 	[93/06/16            dbg]
 * 
...
extern void ipc_task_init(task_t task, task_t parent);
...
extern task_t
convert_port_to_task(ipc_port_t);
...
extern thread_t
convert_port_to_thread(ipc_port_t);
...
convert_port_to_map(ipc_port_t);

extern struct ipc_space *
convert_port_to_space(ipc_port_t);
