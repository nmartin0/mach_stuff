 ...
 * HISTORY
 * $Log:	ipc_port.h,v $
 * Revision 2.15  93/11/17  17:00:41  dbg
 * 	Moved declaration of ipc_port_t to ipc/ipc_types.h to avoid
 * 	circular include file chains.  Added ANSI function prototypes.
 * 	[93/03/30            dbg]
 * 
