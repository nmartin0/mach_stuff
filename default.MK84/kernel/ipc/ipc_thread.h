 ...
 * HISTORY
 * $Log:	ipc_thread.h,v $
 * Revision 2.5  93/11/17  17:03:13  dbg
...
extern void
ipc_thread_enqueue(ipc_thread_queue_t, ipc_thread_t);

extern ipc_thread_t
ipc_thread_dequeue(ipc_thread_queue_t);

extern void
ipc_thread_rmqueue(ipc_thread_queue_t, ipc_thread_t);
