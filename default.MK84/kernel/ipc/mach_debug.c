 ...
 * HISTORY
 * $Log:	mach_debug.c,v $
 * Revision 2.10  93/11/17  17:03:38  dbg
 * 	Added ANSI function prototypes.
 * 	[93/09/24            dbg]
 * 
 * Revision 2.9  92/08/03  17:36:00  jfriedl
 * 	removed silly prototypes
 * 	[92/08/02            jfriedl]
 * 
 * Revision 2.8  92/05/21  17:12:07  jfriedl
 * 	Added some things to quiet gcc warnings.
 * 	[92/05/16            jfriedl]
 * 
 * Revision 2.7  92/02/23  19:52:42  elf
	...
	if (table_info == *tablep) {
		...
		*tableCntp = 0;
		...
		if (size_used != rsize_used)
			bzero((void *) (table_addr + size_used),
