...
/*
 * HISTORY
 * $Log:	ipc_marequest.c,v $
 * Revision 2.11  93/11/17  16:57:53  dbg
 * 	Added ANSI function prototypes.
 * 	[93/09/23            dbg]
 * 
 * Revision 2.10  93/03/09  10:54:41  danner
 * 	Added typecast in hashing macros to shutup GCC.
 * 	[93/03/06            af]
 * 
 * Revision 2.9  92/08/03  17:34:37  jfriedl
 * 	removed silly prototypes
 * 	[92/08/02            jfriedl]
 * 
 * Revision 2.8  92/05/21  17:10:37  jfriedl
 * 	tried prototypes.
 * 	[92/05/20            jfriedl]
 * 
 * Revision 2.7  92/01/14  16:44:37  rpd
 * 	Changed ipc_marequest_info for CountInOut.
 * 	[92/01/14            rpd]
 * 
 * Revision 2.6  91/05/14  16:33:35  mrt
 * 	Correcting copyright
 * 
 * Revision 2.5  91/02/05  17:22:13  mrt
 * 	Changed to new Mach copyright
 * 	[91/02/01  15:46:05  mrt]
 * 
 * Revision 2.4  91/01/08  15:14:11  rpd
 ...
 * 	[90/12/29            rpd]
 * 
 * Revision 2.3  90/12/20  16:38:53  jeffreyh
 * 	Change zchange to match new number of arguments.
 *	Made zone collectable. 
 * 	[90/12/11            jeffreyh]
 * 
 * Revision 2.2  90/06/02  14:50:30  rpd
 * 	Created for new IPC.
 * 	[90/03/26  20:56:33  rpd]
 * 
 */
/*
...
ipc_marequest_init(void)
{
	...
	ipc_marequest_zone =
		zinit(sizeof(struct ipc_marequest),
		      ...
		      FALSE, "ipc msg-accepted requests");
	/* make it exhaustible */
	zchange(ipc_marequest_zone, FALSE, FALSE, TRUE, FALSE);
}
