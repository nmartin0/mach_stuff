 ...
 * HISTORY
 * $Log:	ipc_kmsg.c,v $
 * Revision 2.33  93/11/17  16:57:14  dbg
 * 	Added kmsg type for kernel reply messages.  Added ANSI
 * 	function prototypes.
 * 	[93/03/29            dbg]
 * 
...
#include <device/net_io.h>	/* net_kmsg_put */
	...
	ipc_kmsg_t kmsg)
{
	...
	switch (size) {
	    ...
	    case IKM_SIZE_KERN_REPLY:
		/* return it to the kernel object system */
