 ...
 * HISTORY
 * $Log:	net_io.h,v $
 * Revision 2.9  93/11/17  16:34:24  dbg
...
/*
 * This routine may be called to recycle unneeded net_kmsgs
 * to the general message pool.
 */
extern void net_kmsg_collect(void);

/*
 * Network messages are sent to receive ports at AST time.
 */
