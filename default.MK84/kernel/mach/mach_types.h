 ...
 * HISTORY
 * $Log:	mach_types.h,v $
 * Revision 2.12  93/11/17  17:41:23  dbg
 * 	Include <mach/realtime_policy.h> for realtime policies.
 * 	[93/11/16            dbg]
 * 
 * 	Include mach/policy.h for policy_param_t.
 * 	[93/05/11            dbg]
 * 
 * 	Added types for new clocks and timers, and real-time attributes.
 * 	[93/03/24            dbg]
 * 
...
#include <kern/clock.h>		/* for mach_clock_t */
#include <kern/mach_timer.h>	/* for mach_timer_t */
