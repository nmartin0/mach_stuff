 ...
 * HISTORY
 * $Log:	syscall_sw.h,v $
 * Revision 2.14  93/11/17  17:47:23  dbg
 * 	Added traps for new timers and real-time threads.
 * 	[93/07/13            dbg]
 * 
...
kernel_trap(syscall_periodic_thread_restart,-101,1)
kernel_trap(syscall_timer_arm,-102,8)
kernel_trap(syscall_timer_sleep,-103,5)
kernel_trap(syscall_timer_cancel,-104,2)
