 ...
 * Revision 2.15  93/11/17  16:13:30  dbg
 ...
 * Forward decls
 */
private void check_car( struct tty *, boolean_t );
...
/*
 *	Set up console to point to SCC.
 */
void set_scc_address(
	int		sccunit,
	vm_offset_t	regs,
	boolean_t	has_modem,
	boolean_t	isa_console)
