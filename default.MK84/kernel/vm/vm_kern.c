 ...
 * HISTORY
 * $Log:	vm_kern.c,v $
 * Revision 2.25  93/11/17  18:54:21  dbg
 ...
 * 	projected_buffer_map, projected_buffer_deallocate,
 ...
 */
#include <net_atm.h>		/* projected buffers */
...
void kmem_alloc_pages(
	vm_object_t	object,
	vm_offset_t	offset,
	vm_offset_t	start,
	vm_offset_t	end,
	vm_prot_t	protection);	/* forward */
