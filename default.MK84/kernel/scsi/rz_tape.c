 ...
 * HISTORY
 * $Log:	rz_tape.c,v $
 * Revision 2.17  93/11/17  18:44:46  dbg
 * 	Added include of kern/time_out.h.
 * 	[93/05/21            dbg]
 * 
 * Revision 2.16  93/05/10  21:22:44  rvb
 * 	Added GET_SIZE ioctl. 
 * 	Fixed log and a couple of comments.
 * 	[93/04/09            af]
 * 
 * Revision 2.15  93/01/14  17:55:39  danner
 * 	Changed to use common strategy routine.
 * 	Handle fixed tape errors better (idall is happy).
 * 	64bit cleanup.
 * 	[92/12/01            af]
 * 
 * Revision 2.14  92/08/03  17:54:05  jfriedl
 * 	removed silly prototypes
 * 	[92/08/02            jfriedl]
 * 
 * Revision 2.13  92/05/21  17:23:52  jfriedl
 * 	Cleanup to quiet gcc warnings.
 * 	[92/05/18            jfriedl]
 * 
 * Revision 2.12  92/04/06  23:23:09  rpd
