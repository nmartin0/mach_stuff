...
enum {
    ...
    numberFormattingBadOptionsErr = -5028,
...
//
enum {
    badComponentInstance = 0x00008001,	/* it was 0x8... */
    badComponentSelector = 0x00008002	/* --do */
};
...
enum {
    snsNoSuchTypeErr = -9000,
    snsNoSuchSubscriptionErr = -9001,
    snsNoSuchKindErr = -9002,
    snsDistributorGoneErr = -9003,
    snsQueueEmptyErr = -9004,
    snsNoRequestsPendingErr = -9005,
    snsDuplicateSubscriptionErr = -9006,
    snsDuplicateDistributorErr = -9007,
    snsNoSuchDistributorErr = -9008,
    snsSubjectToLargeErr = -9009,
    snsBufferTooSmallErr = -9010,
    snsConsumerQueueOverrunErr = -9011,
    snsReliabilityFailureErr = -9012,
    snsAlreadyUnheldErr = -9013
...
enum {
    logNoConnectionErr = -29880,
    logDataTooLargeErr = -29881,
    logInvalidVersionErr = -29882,
    logNoSuchActionErr = -29883,
    logServiceInUseErr = -29884,
    logNoMoreEntriesErr = -29885,
    logQueueFullErr = -29886,
    logServiceNotInUseErr = -29887,
    logIteratorInUseErr = -29888,
    logNotATextEntryErr = -29889,
    logNoDataAvailableErr = -29890,
    logInvalidSizeErr = -29891,
    logPluginNotPresentErr = -29892,
    logWrongTypeErr = -29893,
    logEntryCorruptErr = -29894,
    logCannotCreateActionErr = -29895,
    logIteratorInvalidErr = -29896,
    logInvalidSituationTypeErr = -29897,
    logCorruptStoreErr = -29898
};
