...
static __inline__ void mydbdma_st4_endian(volatile unsigned long *a, unsigned long x)
{
long val;
#if 0
    __asm__ volatile
...
#else
    val = ((x & 0xff) << 24) | ((x & 0xff00) << 16) | ((x & 0xff0000) << 8) | (x & 0xff000000);
    *a = val; eieio();
#endif
...
static __inline__ unsigned long mydbdma_ld4_endian(volatile unsigned long *a)
{
    unsigned long swap;
    ...
    swap = ((x & 0xff) << 24) | ((x & 0xff00) << 16) | ((x & 0xff0000) << 8) | (x & 0xff000000);
