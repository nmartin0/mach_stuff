 ...
 * New files.
 *
 * Revision 2.5  93/04/14  11:48:47  mrt
 * 	Removed malloc and free definitions that existed in non KERNEL
 * 	case. They are defined in stdlib.h
 * 	[93/04/02            mrt]
 * 
 * Revision 2.4  92/01/22  22:54:40  rpd
 * 	Added (sortof) memory_object_change_completed.
 * 	[92/01/18            rpd]
 * 
 * 	Fixed includes to use "" when appropriate.
 * 	[92/01/18            rpd]
 * 
 * Revision 2.3  91/07/06  16:13:49  jsb
 * 	Some compilers still do not understand void.
 * 
 * Revision 2.2  91/07/06  15:07:04  jsb
