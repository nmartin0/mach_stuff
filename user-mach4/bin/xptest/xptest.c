 ...
 * HISTORY
 * $Log: xptest.c,v $
 * Revision 1.2  1995/05/04  07:06:06  sclawson
 * various additions for the parisc.
 *
 * Revision 2.6  92/04/07  13:36:54  rpd
    ...
    char *argv[];
{
    ...
    (void) signal(SIGBUS, sigbadmemory);
    (void) signal(SIGSEGV, sigbadmemory);
