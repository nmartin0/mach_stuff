 ...
 * New files.
 *
 * Revision 2.6  93/04/14  11:42:19  mrt
 * 	64bit cleanup.
 * 	[92/12/02            af]
 * 
...
rename_test_3()
{
    ...
    fillin_msg_type(&msg.t, MACH_MSG_TYPE_MOVE_RECEIVE, 8*sizeof(mach_port_t), 1, TRUE, FALSE);
    msg.p = port;
    ...
    check_msg_type(&msg.t, MACH_MSG_TYPE_PORT_RECEIVE, 8*sizeof(mach_port_t), 1, TRUE, FALSE);
    if (msg.p != invalid)
