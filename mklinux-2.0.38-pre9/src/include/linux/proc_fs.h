...
#ifdef	CONFIG_OSFMACH3
enum osfmach3_directory_inos {
	PROC_OSFMACH3_VERSION = 512,
	PROC_OSFMACH3_VM_STATISTICS,
	PROC_OSFMACH3_HOST_SCHED_INFO,
	PROC_OSFMACH3_HOST_BASIC_INFO,
	PROC_OSFMACH3_LAST
};
#endif	/* CONFIG_OSFMACH3 */
...
#ifdef	CONFIG_OSFMACH3
extern struct proc_dir_entry proc_osfmach3;
#endif	/* CONFIG_OSFMACH3 */
...
#ifdef	CONFIG_OSFMACH3
extern void proc_osfmach3_init(void);
#endif	/* CONFIG_OSFMACH3 */
...
#ifdef	CONFIG_OSFMACH3
extern struct inode_operations proc_osfmach3_inode_operations;
#endif	/* CONFIG_OSFMACH3 */
