	...
	mach_port_t name;
{
	...
	thread = convert_port_to_thread((mach_port_t) kern_port);
	...
	mach_port_t name;
{
	...
	task = convert_port_to_task((mach_port_t) kern_port);
	if (IP_VALID(kern_port))
		ipc_port_release_send(kern_port);
	...
	mach_port_t name;
{
	...
	map = convert_port_to_map((mach_port_t) kern_port);
	if (IP_VALID(kern_port))
		ipc_port_release_send(kern_port);
	...
	mach_port_t name;
{
	...
	space = convert_port_to_space((mach_port_t) kern_port);
	if (IP_VALID(kern_port))
		ipc_port_release_send(kern_port);
