...
# HISTORY
# $Log:	setvar.csh,v $
# Revision 2.3  93/03/20  00:46:40  mrt
# 	Made PORTING_FLAGS and environment variable so it could be
# 	used by Makefiles.
# 	[93/03/19            mrt]
# 
# Revision 2.2  93/02/06  17:31:26  mrt
# 	Created
# 	[93/01/10            mrt]
# 
...
if ( $TARGET_MACHINE == "LUNA88K" ) then
    setenv TARGET_CPU "M88K"
    setenv target_cpu "m88k"
else
