...
extern __inline __CONSTVALUE double
__m81_u(__rint)(double __x) __CONSTVALUE2;
extern __inline __CONSTVALUE double
__m81_u(__rint)(double __x)
{
  double __result;
  unsigned long int __ctrl_reg;
  __asm __volatile__ ("fmove%.l %!, %0" : "=dm" (__ctrl_reg));
  /* Set rounding towards nearest.  */
  __asm __volatile__ ("fmove%.l %0, %!" : /* No outputs.  */
		      : "dmi" (__ctrl_reg & ~0x30));
  /* Convert X to an integer, using nearest rounding.  */
  __asm __volatile__ ("fint%.x %1, %0" : "=f" (__result) : "f" (__x));
  /* Restore the previous rounding mode.  */
  __asm __volatile__ ("fmove%.l %0, %!" : /* No outputs.  */
		      : "dmi" (__ctrl_reg));
...
#ifdef __USE_MISC
extern __inline __CONSTVALUE double
__m81_u(rint) (double __x) __CONSTVALUE2;
extern __inline __CONSTVALUE double
__m81_u(rint) (double __x)
{
  return __m81_u (__rint) (__x);
}
#endif
...
extern __inline __CONSTVALUE long double
__m81_u(__rintl)(long double __x) __CONSTVALUE2;
extern __inline __CONSTVALUE long double
__m81_u(__rintl)(long double __x)
{
  long double __result;
  unsigned long int __ctrl_reg;
  __asm __volatile__ ("fmove%.l %!, %0" : "=dm" (__ctrl_reg));
...
#ifdef __USE_MISC
extern __inline __CONSTVALUE long double
__m81_u(rintl) (long double __x) __CONSTVALUE2;
extern __inline __CONSTVALUE long double
__m81_u(rintl) (long double __x)
{
  return __m81_u (__rintl) (__x);
}
#endif
...
__m81_u(powl)(long double __x, long double __y)
{
  ...
  if (__x == 0.0L)
    ...
    {
      long double __temp = __m81_u (floorl) (__y);
      if (__y == __temp)
	{
	  int i = (int) __y;
...
__m81_u(modfl)(long double __value, long double *__iptr)
{
  long double __modf_int = __m81_u(floorl)(__value);
  *__iptr = __modf_int;
  return __value - __modf_int;
}
